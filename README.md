...
The published images are located in the GitHub Container Registry as [geffenlab-bombcell](https://github.com/geffenlab/geffenlab-bombcell/pkgs/container/geffenlab-bombcell).  You can find the latest and previous versions of the step's Docker image there.
...
You can follow the progress of the Docker image build at the step [Actions](https://github.com/geffenlab/geffenlab-bombcell/actions) page.  When the build completes you should see a new [published version](https://github.com/geffenlab/geffenlab-bombcell/pkgs/container/geffenlab-bombcell) with the version tag you provided, like `v0.0.5`.
